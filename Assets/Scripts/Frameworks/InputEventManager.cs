...
public class InputEventManager : MonoBehaviour
{
    ...
    public event Action<GeneralMOInput> onTouchStarted; 
    void TouchStarted(GeneralMOInput touch)
    {
    ...
    public event Action<GeneralMOInput> onTouch;
    void TouchProceed(GeneralMOInput touch)
    {
    ...
    public event Action<GeneralMOInput> onTouchEnd;
    void TouchEnd(GeneralMOInput touch)
    {

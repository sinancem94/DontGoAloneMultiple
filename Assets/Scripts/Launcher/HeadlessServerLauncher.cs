...
//cd GitHub\Projects\DontGoAlone\Builds\ServerBuild
//DontGoAlone.exe -batchmode -nographics -map BuildingBlocks -s 2
//taskkill /IM "DontGoAlone.exe" /F

namespace Launcher
{
	[BoltGlobalBehaviour( "SceneLauncher")]
public class HeadlessServerLauncher : Bolt.GlobalEventListener
{ 
	public string Map = "";
	...
	private void Start()
	{
		...
		config.serverConnectionLimit = int.Parse(Size);
